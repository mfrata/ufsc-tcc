...
% Identificação
\newcommand{\thetitle}{Pre Clustering strategy using firmographics features on a recommender system, a case study at Neoway.}
\newcommand{\theauthor}{Matheus Frata}
\newcommand{\theadvisor}{André Carvalho Bittencourt}
%\newcommand{\thecoadvisor}{Co-orientador}
