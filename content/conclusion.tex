...
%The further improvement of this work would consist on:

%\begin{itemize}
%    \item more development of the clustering module. The manual solutions still need to be automated. One possible way is test with the Gaussian Mixture t
%    \item the inclusion of more metrics. After all, we 
%    \item testing with the user. Feedback from the OT's user 
%\end{itemize}
